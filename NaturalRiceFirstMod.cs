...
using NaturalRiceFirstMod.Items;
using NaturalRiceFirstMod.Items.Pets;
using NaturalRiceFirstMod;
using NaturalRiceFirstMod.Items.LightPets;
using NaturalRiceFirstMod.Items.Mounts;
using NaturalRiceFirstMod.Items.Mounts.InfiniteFlight;
using NaturalRiceFirstMod.Items.Equips.Shirts;

/*using NaturalRiceFirstMod.Items.Plushies;
using NaturalRiceFirstMod.Items.Pets.Elementals;
using NaturalRiceFirstMod.Items.Tiles;
using NaturalRiceFirstMod.Items.Tiles.Blocks;
using NaturalRiceFirstMod.Items.Tiles.FurnitureSets.Bloodstone;
using NaturalRiceFirstMod.Items.Tiles.Plushies;
using NaturalRiceFirstMod.NPCs.Oracle;
using NaturalRiceFirstMod.NPCs.JellyPriest;
using NaturalRiceFirstMod.Items.Equips.Legs.Draedon;
using NaturalRiceFirstMod.ExtraTextures.ChristmasPets;
using NaturalRiceFirstMod.Biomes;
using NaturalRiceFirstMod.Tiles.MiscFurniture;
using NaturalRiceFirstMod.NPCs.TownPets.Nuggets;
using NaturalRiceFirstMod.Items.Pets.TownPets;
using NaturalRiceFirstMod.Items.Dyes;
using NaturalRiceFirstMod.Items.Equips.Balloons;
using NaturalRiceFirstMod.Items.Equips.Capes;
using NaturalRiceFirstMod.Items.Equips.Hats;
using NaturalRiceFirstMod.Items.Equips.Hats.Draedon;
using NaturalRiceFirstMod.Items.Equips.Legs;
using NaturalRiceFirstMod.Items.Equips.Scarves;
using NaturalRiceFirstMod.Items.Equips.Shields;
using NaturalRiceFirstMod.Items.Equips.Shirts.Draedon;
using NaturalRiceFirstMod.Items.Equips.Transformations;
using NaturalRiceFirstMod.Items.Equips.Wings;
using NaturalRiceFirstMod.Items.Equips.Blanks;
using NaturalRiceFirstMod.Items.Hooks;
using NaturalRiceFirstMod.Items.Mounts.LimitedFlight;
using NaturalRiceFirstMod.Walls;
using NaturalRiceFirstMod.Items.Walls.Astral;
using NaturalRiceFirstMod.Items.Walls;
using NaturalRiceFirstMod.AprilFools.Meldosaurus;*/

namespace NaturalRiceFirstMod
{
    public partial class NaturalRiceFirstMod : Mod
    {
        ...
        public static NaturalRiceFirstMod instance;
        public Mod herosmod;
        public Mod ortho;
        public Mod bossChecklist;
        public Mod cata;

        public const string heropermission = "NaturalRiceFirstMod";
        public const string heropermissiondisplayname = "Natrual Rice 1st Mod";
        ...
        public override object Call(params object[] args)
        {
            ...
            if (args[0] is string content)
            {
                switch (content)
                {
                    ...
                    case "downedmeldosaurus":
                    case "Meldosaurus":
                        return NaturalRiceFirstModWorld.downedMeldosaurus;
                    case "downedStratusApocalypse":
                    case "downedstratusapocalypse":
                    case "amogus":
                    case "downedamogus":
                        return NaturalRiceFirstModWorld.amogus;
                    case "inAstralBlight":
                    case "AstralBlight":
                    case "inastralblight":
                    case "oldastral":
                    case "astralblight":
                        return Main.LocalPlayer.GetModPlayer<NaturalRiceFirstModPlayer>().ZoneAstral;
                }
            }
