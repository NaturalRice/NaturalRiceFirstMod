...
{
    public class NurexRemote : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Projectiles.Pets.ExoNRMechs.NurexPet>();
            Item.value = Item.sellPrice(0, 3, 0, 0);
            Item.rare = 11;
            Item.buffType = ModContent.BuffType<Buffs.Pets.ExoNRMechs.NurexBuff>();
        }
        ...
        /*public override void HoldItem(Player player)
        {
            ...
            {
                NaturalRiceFirstMod.Calamity.Call("SetRightClickListener", player, true);
                NaturalRiceFirstMod.Calamity.Call("SetMouseWorldListener", player, true);
            }
        }*/
