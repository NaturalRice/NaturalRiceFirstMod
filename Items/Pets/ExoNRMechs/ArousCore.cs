...
{
    public class ArousCore : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Arous Core");
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Projectiles.Pets.ExoNRMechs.ArousBody>();
            Item.value = Item.sellPrice(0, 3, 0, 0);
            Item.rare = 11;
            Item.buffType = ModContent.BuffType<Buffs.Pets.ExoNRMechs.ArousBuff>();
        }
