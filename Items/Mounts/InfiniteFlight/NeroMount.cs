...
using NaturalRiceFirstMod.Buffs.Mounts;
using System.Linq;
...
{
    public class NeroMount : ModMount
    {
        ...
        {                        
            ...
            //MountData.jumpHeight = 0;//跳跃高度
            //MountData.jumpSpeed = 0f;//跳跃速度            

            //MountData.heightBoost = 15;//坐骑的高度提升
            //MountData.fallDamage = 0f;//坐骑落地时的伤害
            ...
            MountData.buff = ModContent.BuffType<NeroMountBuff>();//坐骑提供的Buff类型
            ...
            //这一系列设置了坐骑在不同状态下的帧延迟，控制动画的速度
            MountData.idleFrameStart = 0;//设置了坐骑在空闲状态下动画帧的起始索引。通常，空闲状态的动画会从第0帧开始播放
            ...
            {
                Asset<Texture2D> texture = ModContent.Request<Texture2D>("NaturalRiceFirstMod/Items/Mounts/InfiniteFlight/NeroMount_Back");
        ...
        public override bool Draw(List<DrawData> playerDrawData, int drawType, Player drawPlayer, ref Texture2D texture, ref Texture2D glowTexture, ref Vector2 drawPosition, ref Rectangle frame, ref Color drawColor, ref Color glowColor, ref float rotation, ref SpriteEffects spriteEffects, ref Vector2 drawOrigin, ref float drawScale, float shadow)
        {
            ...
            Texture2D mountTex = ModContent.Request<Texture2D>("NaturalRiceFirstMod/Items/Mounts/InfiniteFlight/NeroMount_Back_Glow").Value;
        ...
        public override void UpdateEffects(Player player)//通过以下代码已经几乎达到了星流飞椅的效果，唯一遗憾的是向下移动似乎最高只能到51mph？
        {
            ...
            /*// 同步坐骑的位置(这段代码加上后，玩家连同坐骑会不受控制地快速朝左上或右上方移动，很怪
            Vector2 mountedCenter = player.Center + new Vector2((float)(horizontalDirection * 40), -20f); // 调整位置以适应您的坐骑
            player.position = mountedCenter - new Vector2(player.width / 2, player.height);
            player.velocity = Vector2.Zero; // 停止玩家的速度以避免奇怪的运动效果*/
