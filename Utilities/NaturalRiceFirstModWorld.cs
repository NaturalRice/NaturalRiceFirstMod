...
/*using NaturalRiceFirstMod.AprilFools;
using NaturalRiceFirstMod.Tiles.Plants;
...
{
    public class NaturalRiceFirstModWorld : ModSystem
    {
        ...
        /*public override void TileCountsAvailable(ReadOnlySpan<int> tileCounts)
        {
            ...
            {
                // Hell Lab tiles
                hellTiles = tileCounts[NaturalRiceFirstMod.CalamityTile("Chaosplate")];
                // Lab tiles
                labTiles = tileCounts[NaturalRiceFirstMod.CalamityTile("LaboratoryPlating")] + tileCounts[NaturalRiceFirstMod.CalamityTile("LaboratoryPanels")] + tileCounts[NaturalRiceFirstMod.CalamityTile("RustedPlating")] + tileCounts[NaturalRiceFirstMod.CalamityTile("LaboratoryPipePlating")] + tileCounts[NaturalRiceFirstMod.CalamityTile("RustedPipes")];
            }
            //Dungeon tiles
        ...
        /*public override void PreUpdateNPCs()
        {
            ...
            if (Main.drunkWorld)
            {
                NaturalRiceFirstMod.AprilFoolDay = true;
                NaturalRiceFirstMod.AprilFoolWeek = true;
                NaturalRiceFirstMod.AprilFoolMonth = true;
            }
        ...
        {
            NaturalRiceFirstMod.instance.SetupHerosMod();
        }
    }
}