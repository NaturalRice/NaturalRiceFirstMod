...
using NaturalRiceFirstMod.Projectiles.Pets.LightPets;
using NaturalRiceFirstMod.Items.Equips.Shirts;
using NaturalRiceFirstMod.Projectiles.Pets.LightPets;
using NaturalRiceFirstMod.Items.Equips.Shirts.ArousChestplate;
...
using NaturalRiceFirstMod.Buffs.Transformations;
using NaturalRiceFirstMod.Items.Mounts.Morshu;
using NaturalRiceFirstMod.Items.Equips.Balloons;
using NaturalRiceFirstMod.Items.Equips.Backs;
using NaturalRiceFirstMod.Projectiles.Pets.Elementals;
using NaturalRiceFirstMod.Items.Equips.PlayerLayers.ClassSpecific;
...
{
    public class NaturalRiceFirstModPlayer : ModPlayer
    {
        ...
        /*public override void OnHitByNPC(NPC npc, Player.HurtInfo hurtInfo)
        {
            ...
            if (npc.type == NaturalRiceFirstMod.CalamityNPC("SupremeCalamitas") && Player.immuneTime <= 0)
            {
                SCalHits++;
            }
        }*/
        ...
        {
            NaturalRiceFirstModPlayer clone = clientClone as NaturalRiceFirstModPlayer;
        ...
        public override void SyncPlayer(int toWho, int fromWho, bool newPlayer)
        {
            ...
            packet.Write((byte)NaturalRiceFirstMod.MessageType.SyncNaturalRiceFirstModPlayer);
        ...
        {
            NaturalRiceFirstModPlayer clone = clientPlayer as NaturalRiceFirstModPlayer;
            if (clone.SCalHits != SCalHits)
            {
                var packet = Mod.GetPacket();
                packet.Write((byte)NaturalRiceFirstMod.MessageType.SyncSCalHits);
                packet.Write((byte)Player.whoAmI);
                packet.Write(SCalHits);
                packet.Send();
            }
        ...
        /*public static readonly PlayerLayer Mimigun = new PlayerLayer("NaturalRiceFirstMod", "Mimigun", PlayerLayer.Head, delegate (PlayerDrawInfo drawInfo)
        {
