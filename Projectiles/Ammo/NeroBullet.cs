...
namespace NaturalRiceFirstMod.Projectiles.Ammo
{
    public class NeroBullet : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.light = 0.5f; // 投射物周围的光照强度
            Projectile.ignoreWater = true; // 投射物的速度是否受水影响？
