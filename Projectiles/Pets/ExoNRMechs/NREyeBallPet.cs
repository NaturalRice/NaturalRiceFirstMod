...
{
    public class NREyeBallPet : ModProjectile
    {
        ...
        public float SpinRadius => 125 + (Owner.GetModPlayer<NaturalRiceFirstModPlayer>().arous ? 210 : 0); //Change the 200 for any distance you want to add whenever ares is equipped
        ...
        {
            Texture2D tex = (ModContent.Request<Texture2D>("NaturalRiceFirstMod/Projectiles/Pets/ExoNRMechs/NREyeBallPet")).Value;
            ...
            Effect vertexShader = ModContent.Request<Effect>($"{nameof(NaturalRiceFirstMod)}/Effects/VertexShader", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
