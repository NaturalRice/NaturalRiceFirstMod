...
{
    public class ArousBody : ModProjectile
    {
        ...
        {
            NaturalRiceFirstModPlayer modPlayer = Owner.GetModPlayer<NaturalRiceFirstModPlayer>();
            if (Owner.dead)
        ...
        public override bool PreDrawExtras()
        {
            ...
            Texture2D teslaTex = (ModContent.Request<Texture2D>("NaturalRiceFirstMod/Projectiles/Pets/ExoNRMechs/ArousTesla")).Value;
            Texture2D laserTex = (ModContent.Request<Texture2D>("NaturalRiceFirstMod/Projectiles/Pets/ExoNRMechs/ArousLaser")).Value;
            Texture2D nukeTex = (ModContent.Request<Texture2D>("NaturalRiceFirstMod/Projectiles/Pets/ExoNRMechs/ArousNuke")).Value;
            Texture2D plasmaTex = (ModContent.Request<Texture2D>("NaturalRiceFirstMod/Projectiles/Pets/ExoNRMechs/ArousPlasma")).Value;
        ...
        public void DrawSingleArm(Texture2D handTex, Vector2 handPosition, float rotation, Vector2 offset, bool top, bool infernum = false)
        {
            ...
            Texture2D armTex = ModContent.Request<Texture2D>("NaturalRiceFirstMod/Projectiles/Pets/ExoNRMechs/ArousArm").Value;
            Texture2D forearmTex = ModContent.Request<Texture2D>("NaturalRiceFirstMod/Projectiles/Pets/ExoNRMechs/ArousForearm").Value;
        ...
        {
            Texture2D chainTex = ModContent.Request<Texture2D>("NaturalRiceFirstMod/Projectiles/Pets/ExoNRMechs/ArousChain").Value;
        ...
        {
            Texture2D eyesTex = ModContent.Request<Texture2D>("NaturalRiceFirstMod/Projectiles/Pets/ExoNRMechs/ArousEyes").Value;
